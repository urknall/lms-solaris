...
# Supported OSes:
#
# Linux (Perl 5.8.8, 5.10.0, 5.12.4, 5.14.2)
#   i386/x86_64 Linux
#   ARM Linux
#   PowerPC Linux
...
#
#     perlbrew install perl-5.12.4 -D usethreads -D use64bitint -A ccflags=-fno-stack-protector -A ldflags=-fno-stack-protector -Dcc=gcc --notests
#
...
# Path to Perl 5.14.2
if [ -x "$HOME/perl5/perlbrew/perls/perl-5.14.2/bin/perl5.14.2" ]; then
    PERL_514=$HOME/perl5/perlbrew/perls/perl-5.14.2/bin/perl5.14.2
fi
...
if [ $OS = "SunOS" ]; then
    ...
    export GNUMAKE=/bin/gmake
    export MAKE=/bin/gmake
else
...
elif [ $OS = 'Linux' -o $OS = "FreeBSD" -o $OS = "SunOS" ]; then
    # strip all so files
